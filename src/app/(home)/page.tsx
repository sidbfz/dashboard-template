...
import { SalesByCategory } from "@/components/Charts/sales-by-category";
  ...
  return (
    <>
      ...
      <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-9 2xl:gap-7.5">
        ...
        <PerformanceMetrics className="col-span-12 xl:col-span-4" />

        <SalesByCategory className="col-span-12 xl:col-span-7" />
